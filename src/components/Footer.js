import { Foot, TextFooter, SuportLink,SocialIcon, Text, Text2, Float, Info, Info2 }from '../style/styles'
    ...
    return (
        <Foot>
            <TextFooter>
                ...
                <Text>
                <p>
                    A Cacau Lover se compromete em utilizar ovos de galinhas livres de gaiolas em todas as suas operações. Estamos trabalhando para garantir essa transição até 2025.
